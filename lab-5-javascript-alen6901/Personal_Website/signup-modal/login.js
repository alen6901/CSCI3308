function openModal() {
  ...
  myInput.onkeyup = function () {
    ...
    var symbols = /[\!\"\#\$\%\&\'\(\)\*\+\,\-\.\/\:\;\<\>\=\?\@\[\]\{\}\\\\\^\_\`\~]+$/g; // Fill in the regular expression for symbols
...
function enableButton(letter, capital, number, length, match) {
  ...
  var condition = length.classList.contains("valid") && length.classList.contains("valid") && match.classList.contains("valid") && symbol.classList.contains("valid") && number.classList.contains("valid") && capital.classList.contains("valid") && letter.classList.contains("valid"); // TODO: Replace false with the correct condition
  if (condition) {
