...
app.post("/get_feed", function (req, res) {
    ...
    var api_key = "ROGJhyr2cbzSGNpGL9DYdBr9A5OJ3JuD"; // TOOD: Remove null and replace with your API key you received at the setup
    ...
    if (title) {
        axios({
            ...
            .then((items) => {
                ...
                items.data.results.map((obj) => console.log(obj));
                res.render("pages/NYTimes_home", {
                    my_title: "NYTimes search",
